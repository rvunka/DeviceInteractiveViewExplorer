...
4. Custom row click → **`IDIVEDeviceActionHandler::HandleDeviceAction`** (catalog row must have a **Definition** DataAsset — Blueprint child with your fields). See **`QUICKSTART.md`** §1.
