...
- **In-session context menu** — Focus, Isolate on pick; custom rows: **`PickContextMenuByComponent`** + **`UDIVEDeviceActionDefinition`** (optional **Params**) + **`IDIVEDeviceActionHandler`**
