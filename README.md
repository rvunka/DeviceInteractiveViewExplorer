...
- **In-session context menu** — Focus, Isolate on pick; custom rows: **`PickContextMenuByComponent`** + **`UDIVEDeviceActionDefinition`** (optional **Settings**) + **`IDIVEDeviceActionHandler`**
...
7. Custom menu: catalog **Definition** + **`IDIVEDeviceActionHandler`** — **`Docs/QUICKSTART.md`** §1.
